...
> Use this preserved assignment as the source of truth for implementation decisions. All requirements, three task descriptions, and reference screenshots are included here. External links identify their sources.
>
> Source: [original assignment website](https://kolbasa.craft.me/ai_test_task), captured 2026-09-09. Russian wording, punctuation, and typos are preserved. Expandable sections appear under their own headings. Full task descriptions follow under «Примеры задач — полный текст вложенных страниц». Setup advice from the source website, company background, promotions, author metadata, and site controls are omitted as requested. Read [HR evaluation criteria](evaluation-criteria.md) for clarifications and [Acceptance tests](acceptance-tests.md) for verification steps.
